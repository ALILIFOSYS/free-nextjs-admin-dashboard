...
export default function ModalBasedAlerts({handleYes,handleNo}) {
      ...
      >
        <div className="text-center">
          ...
          <div className="flex items-center justify-center w-full gap-3 mt-7">
            <button
              type="button"
              className="flex justify-center w-full mx-5 px-5 py-3 text-sm font-medium text-white rounded-lg bg-gray-700 shadow-theme-xs hover:bg-gray-800 sm:w-auto"
           onClick={handleNo}
           >
              No
            </button>
